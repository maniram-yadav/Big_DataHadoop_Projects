...
In this project we will find out the views of different people on the demonetization by analysing the tweets from twitter. You can find the demonetization twitter data in data folder.
